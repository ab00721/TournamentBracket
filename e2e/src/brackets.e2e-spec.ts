...
describe('Seeding', () => {
  ...
  it('should seed 2 contestants', () => {
    ...
    const player1match1 = match1.element(by.id('player1match1')); // Replace 'player1match1' with the actual ID for player 1
    const player2match1 = match1.element(by.id('player2match1')); // Replace 'player2match1' with the actual ID for player 2
